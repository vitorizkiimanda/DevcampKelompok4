...
class JualEmasScreen extends Component {
  ...
  componentDidMount() {
    Tts.speak('Selamat datang di halaman Penjualan emas')
  ...
  about() {
    Tts.stop()
    Tts.speak('Halaman Penjualan Emas terdiri atas tombol tombol untuk melakukan penjualan emas ')
    this.delay(DELAY_TIME)
    Tts.speak('Tombol kembali berada di kiri atas layar')
    this.delay(DELAY_TIME)
    Tts.speak('Tombol bantuan berada di kanan atas layar')
    this.delay(DELAY_TIME)
    Tts.speak('Tombol konfirmasi penjualan emas berada di bagian tengah layar')
    this.delay(DELAY_TIME)
          ...
          <Button
            ...
            onPress={() => {
              ...
              if (delta < DOUBLE_PRESS_DELAY) {
                ...
                Tts.stop()
                Tts.speak(`Tombol konfirmasi penjualan emas`)
                this.delay(DELAY_TIME)
                Tts.speak(`Jumlah emas yang akan anda beli adalah sebesar 3 gram dengan total harga Rp. 50.000`)
                this.delay(DELAY_TIME)
                Tts.speak(`Tekan dua kali untuk melakukan konfirmasi penjualan emas `)
                this.delay(DELAY_TIME)
              }
              this.lastPress = time
            }}
          ...
          <Button
            ...
            onPress={() => {
              ...
              if (delta < DOUBLE_PRESS_DELAY) {
                ...
                Tts.stop()
                Tts.speak(`Tombol Pengurangan ukuran penjualan Emas`)
                this.delay(DELAY_TIME)
                Tts.speak(`tekan dua kali untuk melakukan pengurangan ukuran penjualan emas`)
                this.delay(DELAY_TIME)
              }
              this.lastPress = time
            }}
          ...
          <Button
            ...
            onPress={async () => {
              ...
              if (delta < DOUBLE_PRESS_DELAY) {
                ...
                this.delay(DELAY_TIME)
                Tts.speak(`Tekan dua kali untuk melakukan penambahan ukuran penjualan emas`)
              }
              this.lastPress = time
            }}
          />
