...
class EmasActivity : BaseActivity() {
    ...
    private fun onClick() {
        ...
        gold_overview.setOnClickListener {
            textToSpeech("Informasi Emas, nilai emas Anda 7010000 rupiah dengan total 10 gram emas, harga emas per gram hari ini 707000 rupiah, harga beli emas kemarin 750000 rupiah, harga jual emas kemarin 720000")
        }
